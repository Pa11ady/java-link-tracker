...
public class ChatLink extends TableImpl<ChatLinkRecord> {
    ...
    public List<ForeignKey<ChatLinkRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CHAT_LINK__FK_CHAT_LINK_CHAT_ID, Keys.CHAT_LINK__FK_CHAT_LINK_LINK_ID);
    }
    ...
    public Chat chat() {
        if (_chat == null)
            _chat = new Chat(this, Keys.CHAT_LINK__FK_CHAT_LINK_CHAT_ID);
    ...
    public Link link() {
        if (_link == null)
            _link = new Link(this, Keys.CHAT_LINK__FK_CHAT_LINK_LINK_ID);

...
public class Link extends TableImpl<LinkRecord> {
    ...
    /**
     * The column <code>public.link.updated</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> UPDATED = createField(DSL.name("updated"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).defaultValue(DSL.field("now()", SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    public List<UniqueKey<LinkRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UC_URL);
    }
